...
// ==== Begin data bind
Blockly.Blocks["datbind"] = {
  init: function () {
    this.appendDummyInput("dumTyp").appendField(
      new Blockly.FieldCheckbox("TRUE", this.validateTyp),
      "chkTyp"
    );
    this.appendValueInput("inVar").setCheck("longvar").appendField(" ");
    this.appendValueInput("id").setCheck("id");
    this.appendValueInput("inConbind").setCheck("conbind").appendField(" =  ");
    this.setInputsInline(true);
    this.setOutput(true, "datbind");
...
// ==== Begin data bind n>= 2
Blockly.Blocks["databind_more_inhabitants"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('declaration'));
    this.setOutput(true, ["datbind"]);
    this.setMutator(new Blockly.icons.MutatorIcon(["databind_more_child"], this));
    this.setTooltip("data bind more then 1 ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("databind_more_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("databind_more_child");
      itemBlock.initSvg();
...
Blockly.Blocks["databind_more_child"] = {
  /**
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("datbind");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Inhabitant of datbind");
    this.contextMenu = false;
  },
};

Blockly.Blocks["databind_more_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Number of datbind");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of datbind");
    this.contextMenu = false;
  },
};
// ==== End data bind n>= 2
