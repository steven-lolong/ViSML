...
// ==== Begin type bind n>= 2
Blockly.Blocks["typebind_more_inhabitants"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('declaration'));
    this.setOutput(true, ["typbind"]);
    this.setMutator(new Blockly.icons.MutatorIcon(["typebind_more_child"], this));
    this.setTooltip("type bind more then 1 ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("typebind_more_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("typebind_more_child");
      itemBlock.initSvg();
...
Blockly.Blocks["typebind_more_child"] = {
  /**
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("Type bind");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Type bind");
    this.contextMenu = false;
  },
};

Blockly.Blocks["typebind_more_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Type binds");
    this.appendStatementInput("STACK");
    this.setTooltip("Type binds");
    this.contextMenu = false;
  },
};
// ==== End type bind n>= 2
