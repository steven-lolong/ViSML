...
Blockly.Blocks["dec_open"] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["dec_open_child"], this));
    this.setTooltip("fun ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("dec_open_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("dec_open_child");
      itemBlock.initSvg();
...
Blockly.Blocks["dec_open_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Sequence of Long ID");
    this.appendStatementInput("STACK");
    this.setTooltip("Sequence of Long ID");
    this.contextMenu = false;
  },
};
// ===== End decopen
