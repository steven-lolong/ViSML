...
// ==== End exn bind
// ==== Begin exn bind
Blockly.Blocks["exnbind_renaming"] = {
  init: function () {
    this.appendValueInput("id").setCheck("id");
...
// ==== Begin exn bind n>= 2
Blockly.Blocks["exnbind_more_inhabitants"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('declaration'));
    this.setOutput(true, ["exnbind"]);
    this.setMutator(new Blockly.icons.MutatorIcon(["exnbind_more_child"], this));
    this.setTooltip("exn bind more then 1 ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("exnbind_more_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("exnbind_more_child");
      itemBlock.initSvg();
...
Blockly.Blocks["exnbind_more_child"] = {
  /**
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("exnbind");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Inhabitant of exnbind");
    this.contextMenu = false;
  },
};

Blockly.Blocks["exnbind_more_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Number of exnbind");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of exnbind");
    this.contextMenu = false;
  },
};
// ==== End exn bind n>= 2
