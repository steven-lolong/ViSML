...
Blockly.Blocks["dec_val"] = {
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["val_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("val_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("val_child");
      itemBlock.initSvg();
...
Blockly.Blocks["val_child_container"] = {
  /**
