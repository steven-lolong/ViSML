...
Blockly.Blocks["funmatch_infix"] = {
  ...
  updateTextFieldTyp: function () {
    ...
    if (this.chkTyp && !input) {
      ...
      this.moveInputBefore("inTyp", "inexp");
...
// ======= Start more than one inhabitant
Blockly.Blocks["funmatch_more_row"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('declaration'));
    this.setOutput(true, ["funmatch"]);
    this.setMutator(new Blockly.icons.MutatorIcon(["funmatch_child"], this));
    this.setTooltip("fun ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("funmatch_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("funmatch_child");
      itemBlock.initSvg();
...
Blockly.Blocks["funmatch_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("funmatch");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Inhabitant of funmatch");
    this.contextMenu = false;
  },
};

Blockly.Blocks["funmatch_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Number of funmatch");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of funmatch");
    this.contextMenu = false;
  },
};
// ===== End more than one inhabitant
