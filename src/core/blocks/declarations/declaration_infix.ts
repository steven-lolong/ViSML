...
Blockly.Blocks["dec_infix"] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["dec_infix_child"], this));
    this.setTooltip("Left-associative infix");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("dec_infix_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("dec_infix_child");
      itemBlock.initSvg();
...
Blockly.Blocks["dec_infix_child"] = {
  /**
...
Blockly.Blocks["dec_infix_child_container"] = {
  /**
