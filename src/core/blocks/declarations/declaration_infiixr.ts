...
Blockly.Blocks["dec_infixr"] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["dec_infixr_child"], this));
    this.setTooltip("fun ");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("dec_infixr_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("dec_infixr_child");
      itemBlock.initSvg();
...
Blockly.Blocks["dec_infixr_child"] = {
  /**
...
Blockly.Blocks["dec_infixr_child_container"] = {
  /**
