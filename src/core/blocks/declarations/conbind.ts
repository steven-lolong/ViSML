...
Blockly.Blocks["conbind"] = {
  init: function () {
    ...
    this.appendValueInput("inVar").setCheck("typ").appendField(" of ");
    this.setInputsInline(true);
    this.setOutput(true, "conbind");
...
// ==== Begin data bind n>= 2
Blockly.Blocks["conbind_more_inhabitants"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('declaration'));
    this.setOutput(true, ["conbind"]);
    this.setMutator(new Blockly.icons.MutatorIcon(["conbind_more_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("conbind_more_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("conbind_more_child");
      itemBlock.initSvg();
  ...
  updateShape_: function () {
    ...
    for (var i = 0; i < this.itemCount_; i++) {
      if (!this.getInput("ADD" + i)) {
        ...
        if (i > 0) {
          input.appendField(
            new Blockly.FieldLabelSerializable("or  "),
            "desc" + i
          );
        }
      }
...
Blockly.Blocks["conbind_more_child"] = {
  /**
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("Data constructor");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Data constructor");
    this.contextMenu = false;
  },
};

Blockly.Blocks["conbind_more_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('declaration'));
    this.appendDummyInput().appendField("Data constructors");
    this.appendStatementInput("STACK");
    this.setTooltip("Data constructors");
    this.contextMenu = false;
  },
};
// ==== End data bind n>= 2
