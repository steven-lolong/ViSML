...
Blockly.Blocks["spec_sequence"] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["spec_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("spec_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("spec_child");
      itemBlock.initSvg();
...
Blockly.Blocks["spec_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("spec");
...
Blockly.Blocks["spec_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Number of spec");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of spec");
    this.contextMenu = false;
  },
};
// ===== Endspecsequence_
