...
// Begin exndesc single
Blockly.Blocks["exndesc_single"] = {
  init: function () {
...
// Begin exndesc recursive
Blockly.Blocks["exndesc_nested"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('signature'));
    this.setOutput(true, "exndesc");
    this.setMutator(new Blockly.icons.MutatorIcon(["exndesc_child"], this));
    this.setTooltip("exndesc ");
    this.itemCount_ = 2;
    this.updateShape_();
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("exndesc_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("exndesc_child");
      itemBlock.initSvg();
...
Blockly.Blocks["exndesc_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("exndesc");
...
Blockly.Blocks["exndesc_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Number of exndesc");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of exndesc");
    this.contextMenu = false;
  },
};
// ===== Endexndesc_nested
