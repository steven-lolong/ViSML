...
// Begin condesc single
Blockly.Blocks["condesc_single"] = {
  init: function () {
    ...
    this.appendValueInput("inputVar").setCheck("typ").appendField("of");
    this.setOutput(true, "condesc");
  ...
  updateTextFieldTyp: function () {
    ...
    if (this.chkSub && !input) {
      this.appendValueInput("inputVar").setCheck("typ").appendField("of");
      this.moveInputBefore("inputVar", null);
...
// Begin condesc recursive
Blockly.Blocks["condesc_nested"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('signature'));
    this.setOutput(true, "condesc");
    this.setMutator(new Blockly.icons.MutatorIcon(["condesc_child"], this));
    this.setTooltip("condesc ");
    this.itemCount_ = 2;
    this.updateShape_();
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("condesc_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("condesc_child");
      itemBlock.initSvg();
...
Blockly.Blocks["condesc_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("condesc");
...
Blockly.Blocks["condesc_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Number of condesc");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of condesc");
    this.contextMenu = false;
  },
};
// ===== Endcondesc_nested
