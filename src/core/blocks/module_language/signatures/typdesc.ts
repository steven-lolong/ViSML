...
// Begin typdesc single
Blockly.Blocks["typdesc_single"] = {
  init: function () {
  ...
  updateTextFieldTyp: function () {
    ...
    if (this.chkSub && !input) {
      this.appendValueInput("inputVar").setCheck("longvar");
      this.moveInputBefore("inputVar", "inputId");
...
// Begin typdesc recursive
Blockly.Blocks["typdesc_nested"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('signature'));
    this.setOutput(true, "typdesc");
    this.setMutator(new Blockly.icons.MutatorIcon(["typdesc_child"], this));
    this.setTooltip("typdesc ");
    this.itemCount_ = 2;
    this.updateShape_();
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("typdesc_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("typdesc_child");
      itemBlock.initSvg();
...
Blockly.Blocks["typdesc_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("typdesc");
...
Blockly.Blocks["typdesc_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Number of typdesc");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of typdesc");
    this.contextMenu = false;
  },
};
// ===== Endtypdesc_nested
