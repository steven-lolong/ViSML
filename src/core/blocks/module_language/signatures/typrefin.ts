...
// Begin typrefin single
Blockly.Blocks["typrefin_single"] = {
  init: function () {
    this.appendDummyInput("chkInputVar").appendField(
      new Blockly.FieldCheckbox("TRUE", this.validateTyp),
      "chkSub"
    );
    this.appendValueInput("inputVar").setCheck("var");
    this.appendDummyInput("separator").appendField("  ");
    this.appendValueInput("inputLongid").setCheck("longid");
    this.appendValueInput("inputTyp").setCheck("typ").appendField("= ");
    this.setOutput(true, "typrefin");
  ...
  updateTextFieldTyp: function () {
    ...
    if (this.chkSub && !input) {
      this.appendValueInput("inputVar").setCheck("var");
      this.moveInputBefore("inputVar", "separator");
...
// Begin typrefin recursive
Blockly.Blocks["typrefin_nested"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('signature'));
    this.setOutput(true, "typrefin");
    this.setMutator(new Blockly.icons.MutatorIcon(["typrefin_child"], this));
    this.setTooltip("typrefin ");
    this.itemCount_ = 2;
    this.updateShape_();
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("typrefin_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("typrefin_child");
      itemBlock.initSvg();
...
Blockly.Blocks["typrefin_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("Refinement");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("Refinement");
    this.contextMenu = false;
  },
};

Blockly.Blocks["typrefin_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Refinements");
    this.appendStatementInput("STACK");
    this.setTooltip("Refinements");
    this.contextMenu = false;
  },
};
// ===== Endtyprefin_nested
