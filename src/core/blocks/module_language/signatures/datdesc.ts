...
// Begin datdesc single
Blockly.Blocks["datdesc_single"] = {
  init: function () {
    this.appendDummyInput("chkInputVar").appendField(
      new Blockly.FieldCheckbox("TRUE", this.validateTyp),
      "chkSub"
    );
    this.appendValueInput("inputVar").setCheck("longvar");
    this.appendDummyInput("separator").appendField("");
    this.appendValueInput("inputId").setCheck("id");
    this.appendValueInput("inputConDesc").setCheck("condesc").appendField("= ");
    this.setOutput(true, "datdesc");
...
// Begin datdesc recursive
Blockly.Blocks["datdesc_nested"] = {
  /**
  ...
  init: function () {
    ...
    this.setColour(getColorByType('signature'));
    this.setOutput(true, "datdesc");
    this.setMutator(new Blockly.icons.MutatorIcon(["datdesc_child"], this));
    this.setTooltip("datdesc ");
    this.itemCount_ = 2;
    this.updateShape_();
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("datdesc_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("datdesc_child");
      itemBlock.initSvg();
...
Blockly.Blocks["datdesc_child"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField("datdesc");
...
Blockly.Blocks["datdesc_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('signature'));
    this.appendDummyInput().appendField("Number of datdesc");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of datdesc");
    this.contextMenu = false;
  },
};
// ===== Enddatdesc_nested
