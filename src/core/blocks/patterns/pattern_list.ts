...
Blockly.Blocks["pat_list"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput("secondType")
      ...
      .appendField("List Extractor");
    this.setColour(getColorByType('pattern'));
    this.setOutput(true, ["pat"]);
    this.setTooltip("list of pattern");
    this.setMutator(new Blockly.icons.MutatorIcon(["pat_list_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("pat_list_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("pat_list_child");
      itemBlock.initSvg();
...
Blockly.Blocks["pat_list_child"] = {
  ...
  init: function () {
    ...
    this.setTooltip("Inhabitant of the list");
    this.contextMenu = false;
  },
};

Blockly.Blocks["pat_list_child_container"] = {
  /**
