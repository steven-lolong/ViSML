...
Blockly.Blocks["pat_record"] = {
  ...
  init: function () {
    ...
    this.setTooltip("record of pattern");
    this.setMutator(new Blockly.icons.MutatorIcon(["pat_record_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("pat_record_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("pat_record_child");
      itemBlock.initSvg();
...
Blockly.Blocks["pat_record_child"] = {
  /**
...
Blockly.Blocks["pat_record_child_container"] = {
  /**
