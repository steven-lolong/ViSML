...
// ======= Start constructor
Blockly.Blocks["typ_constructor"] = {
  /**
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["constructor_child"], this));
    this.setTooltip("Constructor");
    this.moveInputBefore("longid", null);
    this.moveInputBefore("closeDumpBracket", "longid");
  },
  onchange: function () {
    if (this.getParent()) this.setFieldValue("", "desc");
    else this.setFieldValue("Constructor", "desc");
  },
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("constructor_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("constructor_child");
      itemBlock.initSvg();
...
Blockly.Blocks["constructor_child"] = {
  /**
   * Mutator block for adding items.
   * @this {Blockly.Block}
   */
  init: function () {
    this.setColour(getColorByType('type_sub'));
...
Blockly.Blocks["constructor_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('type'));
    this.appendDummyInput().appendField("Sequence of type");
    this.appendStatementInput("STACK");
    this.setTooltip("Sequence of type");
    this.contextMenu = false;
  },
};
// ===== End constructor
