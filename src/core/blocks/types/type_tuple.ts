...
Blockly.Blocks["typ_tuple"] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["typ_tuple_child"], this));
    this.setTooltip("tuple");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("typ_tuple_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("typ_tuple_child");
      itemBlock.initSvg();
...
Blockly.Blocks["typ_tuple_child"] = {
  /**
  ...
  init: function () {
    ...
    this.setTooltip("Inhabitant of type");
    this.contextMenu = false;
  },
};

Blockly.Blocks["typ_tuple_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('type'));
    this.appendDummyInput().appendField("Number of type");
    this.appendStatementInput("STACK");
    this.setTooltip("Number of sequence type");
    this.contextMenu = false;
  },
};
// ===== End tuple
