...
Blockly.Blocks["typ_record"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput("openDumpBracket").appendField(
      new Blockly.FieldLabelSerializable("Record"),
      "open_bracket"
    );
    this.itemCount_ = 1;
    this.updateShape_();
    ...
    this.setMutator(new Blockly.icons.MutatorIcon(["typ_record_child"], this));
    this.setTooltip("Record type");
  },
  // change on block
  onchange: function () {
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("typ_record_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("typ_record_child");
      itemBlock.initSvg();
  ...
  updateShape_: function () {
    ...
    while (this.getInput("ADD" + i)) {
      ...
      this.removeInput("TYP" + i);
      i++;
    }
  },
};

Blockly.Blocks["typ_record_child"] = {
  /**
  ...
  init: function () {
    ...
    this.setTooltip("Inhabitant of record");
    this.contextMenu = false;
  },
};

Blockly.Blocks["typ_record_child_container"] = {
  /**
