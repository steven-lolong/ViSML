...
Blockly.Blocks["exp_sequence"] = {
  /**
   * Block for creating a sequence with any number of elements of any type.
   * @this {Blockly.Block}
   */
  init: function () {
    this.itemCount_ = 2;
    ...
    this.appendDummyInput("secondType")
      ...
      .appendField("Expressions");
    this.setColour(getColorByType('expression'));
    this.setOutput(true, ["exp"]);
    this.setTooltip("Sequence of expression");
    this.setMutator(new Blockly.icons.MutatorIcon(["sequence_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("sequence_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("sequence_child");
      itemBlock.initSvg();
...
Blockly.Blocks["sequence_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('expression'));
    this.appendDummyInput().appendField("Expressions");
