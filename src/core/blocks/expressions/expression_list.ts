...
Blockly.Blocks["exp_list"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput("secondType")
      ...
      .appendField("List Constructor");
    this.setColour(getColorByType('expression'));
    this.setOutput(true, ["exp"]);
    this.setTooltip("list of expression");
    this.setMutator(new Blockly.icons.MutatorIcon(["list_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("list_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("list_child");
      itemBlock.initSvg();
...
Blockly.Blocks["list_child"] = {
  ...
  init: function () {
    ...
    this.setTooltip("Item of the list");
    this.contextMenu = false;
  },
};

Blockly.Blocks["list_child_container"] = {
  /**
  ...
  init: function () {
    ...
    this.setTooltip("Number of items in the list");
    this.contextMenu = false;
  },
};
