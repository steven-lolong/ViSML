...
// Record selector"./image
Blockly.Blocks["exp_record_select"] = {
  init: function () {
    this.appendValueInput("lab")
      .setCheck(["lab"])
      .appendField(
...
Blockly.Blocks["exp_record"] = {
  ...
  init: function () {
    ...
    this.setColour(getColorByType('expression'));
    this.setOutput(true, ["exp"]);
    this.setTooltip("record of expression");
    this.setMutator(new Blockly.icons.MutatorIcon(["record_child"], this));
  ...
  decompose: function (workspace) {
    var containerBlock = workspace.newBlock("record_child_container");
    containerBlock.initSvg();
    var connection = containerBlock.getInput("STACK").connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock("record_child");
      itemBlock.initSvg();
...
Blockly.Blocks["record_child"] = {
  ...
  init: function () {
    ...
    this.setTooltip("Field of the record");
    this.contextMenu = false;
  },
};

Blockly.Blocks["record_child_container"] = {
  /**
  ...
  init: function () {
    this.setColour(getColorByType('expression'));
    this.appendDummyInput().appendField("Record");
    this.appendStatementInput("STACK");
    this.setTooltip("Inhabitant of the record");
    this.contextMenu = false;
  },
};
